...
test("Daytime 160K and Nighttime 128K selections expose independent request contracts", () => {
  ...
  assert.match(canonical, /displayName: Daytime \(160K\)/);
  assert.match(canonical, /name: Daytime \(160K\)/);
  assert.match(canonical, /contextWindow: 163840/);
